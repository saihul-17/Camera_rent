document.addEventListener('DOMContentLoaded', function() {
    ...
    function performLogin(email, password) {
        ...
        if (email === adminCredentials.email && password === adminCredentials.password) {
            ...
            window.location.href = 'admin.html'; // Admin tetap ke admin.html
            return true;
        } else {
            ...
            if (isValidEmail(email) && password.length >= 6) {
                ...
                // Redirect ke halaman index.html (beranda) untuk pengguna biasa
                window.location.href = 'beranda.html'; // <<<-- DIUBAH KE index.html
                return true;
            } else {
